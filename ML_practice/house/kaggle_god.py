...
X_train.to_csv('E:\\house\\x_train1f.csv',index=None)
y_train.to_csv('E:\\house\\y_train1f.csv',index=None)
X_test.to_csv('E:\\house\\x_test1f.csv',index=None)
c=2/0
import numpy as np
import pandas as pd
...
cv_model = [rmse_cv(Lasso(alpha=alpha,max_iter=70), X_train, y_train).mean() for alpha in alphas]
