...
# Load the data.
train_df = pd.read_csv('E:\\house\\train.csv')
test_df = pd.read_csv('E:\\house\\test.csv')
...
train_df_munged.index=range(len(train_df_munged))
test_df_munged.index=range(len(test_df_munged))
label_df.index=range(len(label_df))

train_df_munged.to_csv('E:\\house\\train_df.csv')
###################################### stacking ####################################
list_index1=[list(range(0,970)),list(range(970,1455)),list(range(0,485))+list(range(970,1455))] #train
list_index2=[list(range(970,1455)),list(range(0,970)),list(range(485,970))] #test
...
pred=stacking_train(train_df_munged, label_df,list_index1,list_index2,test_df_munged)
y_test=list(np.exp(list(pred)))
...
pred_df.to_csv('e:\\house\\utput.csv', header=True, index_label='Id')