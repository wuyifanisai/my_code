...
public class demo {
	...
	public static class Animal { // 因为是在主方法之外定义的，所以需要static关键词，以便主方法中可调用
		int age;
		String color;
		String sex;
		public String name;
	...
	public static class Dog extends Animal {// 因为是在主方法之外定义的，所以需要static关键词，以便主方法中可调用
	...
	public static class Cat extends Animal {// 因为是在主方法之外定义的，所以需要static关键词，以便主方法中可调用
	...
	public interface Anmial_generate {// 定义一个接口
		public void mating();

		public void delivering();
	}

	public static class Live_dog implements Anmial_generate {// 因为是在主方法之外定义的，所以需要static关键词，以便主方法中可调用
		// 定义具体的接口实现类
		@Override
		public void mating() {
	...
	public static void animal_protected() { // 因为是在主方法之外定义的，所以需要static关键词，以便主方法中可调用
